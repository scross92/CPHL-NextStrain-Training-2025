# West Nile Virus (WNV) Nextstrain Build
...
<details>
  <summary><b>Click here for the answer</b></summary>
  The length of the genome sequences vary drastically in size. Some are near complete while others are just fractions of the genome.
</details>
...
<details>
  ...
  - INSDC accesssion (Genbank Accesion number)

  - Lineage (Even though we have already filtered by lineage, this is helpful metadata to have downstream for publishing purposes)
  
  - Collection Country

  - Collection Subdivision 1
  
  - Collection Date
  
  - Isolate Name (this is the strain name)

  - Display Name (this is how Pathoplexus names the strains)
</details>
...
If we dig into the "specimenCollectorSampleId" column you notice the same issue as before. These are the blank strain names. As a reminder, Pathoplexus has solved this issue by giving it 'custom' strain names. Looking at the first sample in the metadata file, can you figure out how Pathoplexus names the strains? 
